...
class Student:
    def __init__(self,root):
        ...
        #First_Img
        img = Image.open(r'C:\Users\dashrath singh\OneDrive\Desktop\Student_Management_System_tinkter\college_images\pexels-emily-ranquist-1205651.jpg')
        ...
        #secondimg
        img1 = Image.open(r'C:\Users\dashrath singh\OneDrive\Desktop\Student_Management_System_tinkter\college_images\pexels-fox-1595391.jpg')
        ...
        #thirdimg
        img2 = Image.open(r'C:\Users\dashrath singh\OneDrive\Desktop\Student_Management_System_tinkter\college_images\pexels-pixabay-267885.jpg')
    ...
    #Button Frame:
        ...
        save_btn=Button(button_frame,text='Save',command=self.add_data,font=('times new roman',12,'bold'),bg='blue',fg='white',width=19)
        ...
        delete_btn=Button(button_frame,text='Delete',command=self.delete_data,font=('times new roman',12,'bold'),bg='blue',fg='white',width=19)
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(button_frame,text='Reset',command=self.reset_data,font=('times new roman',12,'bold'),bg='blue',fg='white',width=19)
        ...
        take_photo_btn=Button(button_frame1,command=self.generate_dataset,text='Take Photo Sample',width=39,font=('times new roman',12,'bold'),bg='blue',fg='white')
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(button_frame1,text='Update Photo Sample',width=39,font=('times new roman',12,'bold'),bg='blue',fg='white')
        update_photo_btn.grid(row=0,column=1)

        # Right_side label frame
        ...
        show_btn=Button(Search_frame,text='Show All',font=('times new roman',12,'bold'),bg='blue',fg='white',width=14)
        ...
        self.student_table = ttk.Treeview(Table_frame,column=('dep','course','year','sem','id','name','div','roll','gender','dob','email','teacher','phone','address','photo'),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.fetch_data()
    # ===============Function declaration for adding data==================
    ...
    # <===============Function declaration for UPDATING Data:================>
        ...
        if self.var_dep.get()=='Select Department' or self.var_std_name.get()=='' or self.var_std_id=='':
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='Amazon111@',database='face_recognition')
                    my_cursor=conn.cursor()
                    my_cursor.execute('update student set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Dob=%s,Gender=%s,Email=%s,Address=%s,Phone=%s,Teacher=%s,PhotoSample=%s where Student_id=%s',(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                        self.var_semester.get(),
    ...
    # <===============Function declaration for DELETING Data:================>
    def delete_data(self):
        if self.var_std_id.get()=='':
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo('Success_Delete','Successfully deleted the row',parent=self.root)
            except Exception as es:
                messagebox.showerror('Error',f'Due to:{str(es)}',parent=self.root)
    
    # <===============Function declaration for Reseting Data:================>
    def reset_data(self):
    ...
    def generate_dataset(self): 
        if self.var_dep.get()=='Select Department' or self.var_std_name.get()=='' or self.var_std_id=='':
            ...
            try:
                ...
                # print(myresult)
                #For matching student_id with images:
                id=0
                for x in myresult:
                    id+=1
                print(id)
